...
namespace Management.EntityFramework.Repositories
{
    public class EFRepository/*<TEntity> where TEntity : class*/
    {
        ...
        private readonly EFDBContext _DbContextHandle;//此处进行调用EF的DBContent 的实体类或者通过工厂化模式来进行调用。
        //protected readonly DbSet<TEntity> _dbSet;
        public EFRepository()
        {
            this._DbContextHandle = new EFDBContext();
            //this._DbContextHandle = new EFDBContext();
            //this._dbSet = this._DbContextHandle.Set<TEntity>();
